...
<body>
<h3>当前位置：功能列表</h3>
<a href="${pageContext.request.contextPath}/order/query" style="text-align: right" >订单管理</a>&nbsp;&nbsp;
<a href="${pageContext.request.contextPath}/visitorinfo?message=query" style="text-align: right">车主信息</a>&nbsp;&nbsp;
<a href="${pageContext.request.contextPath}/parkcarinfo/query" style="text-align: right">停车场车位信息</a>&nbsp;&nbsp;
