        ...
        <tr>
            ...
            <td>
                <div>
                    ...
                    <a href="${pageContext.request.contextPath}/parkcarinfo/update?parkNo=${parkcarinfo.parkNo}" >修改</a>
                    <a href="${pageContext.request.contextPath}/parkcarinfo/delete?parkNo=${parkcarinfo.parkNo}" >删除</a>
                </div>
            </td>
        </tr>
    </c:forEach>
...
<script>
    function search(){
        ...
        window.location.href='${pageContext.request.contextPath}/parkcarinfo/query?keyword='+v ;
    }
</script>
</body>
</html>
